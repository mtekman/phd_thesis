...
The following table contains the average chromosome-specific\footnote{\label{ref:footnote:singlecorefull}For a full disclosure of all trials run, please see Appendix page~\pageref{ref:app:singlecoreindiv}.} runtimes that comprise the single-core components of Table~\ref{table:res:allegrosingleruntimes}.
...
\fignow{../writer/Results/tables/runtimes_multicore_vs_singlecore.png}
