...
\caption[Allegro Single-Core runtimes, 4 trials per chromosome, per bit-size]{Allegro Single-Core Runtimes (4 trials per bit-size per chromosome). B is bit-size, and T is trial number. A plot of these points can be found in Figure~\ref{fig:res:singleplots} on Page~\pageref{fig:res:singleplots}.}
\end{table}
\thispagestyle{empty}
