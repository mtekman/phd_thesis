...
Free Software Movement guru Richard Stallman was the first to create a Copyleft license, the GNU General Public License (GPL), which has gone on to make two more versions:
	\begin{enumerate}
	\item{\textbf{GPLv2}
		\begin{enumerate}
...
\caption{Allegro Single-Core Runtimes (4 trials per bit-size per chromosome). B is bit-size, and T is trial number.}
\end{table}
\thispagestyle{empty}
