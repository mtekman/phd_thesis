...
\fignow{./Sections/images/yuv_scale.png}
{YUV scale for Y = 0.5 (compressed). Image courtesy of Wikimedia Commons.}
{fig:app:yuv}
{0.3}
{YUV scale for Y = 0.5 (compressed).}
...
\fignow{./Sections/images/poisson.png}
...
{
	\vspace{-20pt}
	\fignow{../writer/Results/images/interesting_cases/109_5k_scenarios/Summary_scenarios_chr\x.jpg}
