...
\addglossprog{GTK}{Gimp Toolkit, cross-platform set of widgets sued for creating graphical interfaces.}
...
\addglossprog{sudo}{Utility that allows a user to perform tasks under the security privileges of another user (default:root).}