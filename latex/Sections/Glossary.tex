...
%-    Chromosomes
\addglossbio{chromatin}{condensed DNA wrapped around proteins to fit in nucleus}
\addglossbio{haploid}{cell with a single set of unpair chromosomes.}
\addglossbio{pairs}{}
...
\addglossbio{uracil}{mRNA equivalent of Thymine}
\addglossbio{splicing}{Process of cutting introns out of gene locus and stitching together exons.}
\addglossbio{transcription}{DNA being coped into mRNA by \glslink{RNA polymerase}}
...
\addglossbio{multi-point parametric}{Linkage analysis that uses a map of genetic markers to reconstruct inheritance along a chromosome. LOD is calculated by comparing each marker against an unlinked locus.}
...
\addglosscomp{ihaplo.out}{The Allegro haplotypes output file.}
...
\addglosscomp{KineticJS}{2D Javascript framework}
...
\addglosscomp{Linux}{Free Open-Source operating system concieved by Linus Torvalds.}
