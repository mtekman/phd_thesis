...
{\noindent Glossary entries are marked up using {\glsfont{this font}}, and program list entries are outlined using {\progstyle{this font}}. Only the first mention of each entry in a chapter is emphasized.}\\
